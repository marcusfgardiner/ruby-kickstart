...
# i.e. you run all the below by putting the object/module you are checking on the left, then a ., then the method you are running on the right 
# e.g. Object.inspect 
...
# what class is the object? => use .class 
1.class                             # => Fixnum
1.0.class                           # => Float
"abc".class                         # => String
# (this also will return a class that you have made up and defined, e.g. class Person. There are a bunch of pre-existing classes like Float, Array, Hash etc)
audrey.class                        # => Person
...
# instance variable = variable that is only accessible within that instance of a class. They are accessed using the @ operator
# e.g. for the below, the instance variables are the variables that only relate to Audrey as an instance of a broader class for which there can be lots of instances
# i.e. within a real example of a class (a real instance), what variables can you have for that specific instance e.g. for a person its name, birthday, age etc...
# Instance variables are created for each class instance and are accessible only within that instance. They are accessed using the @ operator. 
...
# what methods does the object have? (incl. you can define your own new methods (i.e. code blocks) for a class within the definition of your class e.g. Person)
...
#private methods (In Ruby, you can only access private methods for your instance of object, and not for any other object instance)
